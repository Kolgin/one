...
@section('content')
    <div class="page-header clearfix">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mt-0 mb-5">Редактирование профиля партнера</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Апанде</a></li>
                    <li><a href="#">Cтраничка пользователя</a></li>
                ...
                <div style="width: auto" class="media-body media-middle">
                    ...
                    <form enctype="multipart/form-data" method="post">
                        <p><input type="file" name="f" value="Выберите аватарку">
                            <input type="submit" value="Загрузить аватаркsу "></p>
                    ...
                    <a href="/admin/partners/1"><button type="button" class="btn btn-default" style="width: 150px">Сохранить</button></a>
                ...
                <div class="widget-body">
                    <ul class="media-list mb-0">
                        ...
                        <li class="media">
                            {{--<div class="media-left"><i class="ti-briefcase text-info"></i></div>--}}
                            <div class="media-body">
                                <p>Реферальный код данного партнера: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="8757865875876">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <input id="txtCustomerName" type="text" class="form-control" value=" 5">
                                <p>Кол-во продаж: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="34">
                                <p>Кол-во продаж по сумме: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="50">
                                <p>Кол-во заработанных денег: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="34543">
                                <p>Кол-во денег которые должны отдать: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="543">
                            </div>
                            </p>
...
@section('script')
    ...
    <script type="text/javascript" src="/build/js/page-content/pickers/date-range-picker.js"></script>
    <script type="text/javascript" src="/build/js/page-content/charts/chart-js.js"></script>
@stop