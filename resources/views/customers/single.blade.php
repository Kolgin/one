...
@section('content')
    <div class="page-header clearfix">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mt-0 mb-5">Профиль клиента</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Апанде</a></li>
                    <li><a href="#">Стоничка пользователя</a></li>
                    ...
                    <div class="widget clear">
                        <div class="col-md-3">
                            <div style="width: auto" class="media-body media-middle">
                                ...
                                <a href="/admin/customers/1/edit"><button type="button" class="btn btn-default" style="width: 150px">Редактировать</button></a>
                            </div>
                        </div>
                        {{--<div class="col-md-6">--}}
                            {{--<div class="widget clear">--}}
                                ...
                                {{--<div class="widget-body">--}}
                                    {{--<ul class="media-list mb-0">--}}
                                        ...
                                        {{--<li class="media">--}}
                                            {{--<div class="media-left"><i class="ti-briefcase text-info"></i></div>--}}
                                            {{--<div class="media-body">--}}
                                                {{--<p>Группа покупателей: +30955447172</p>--}}
                                        ...
                                        {{--<li class="media">--}}
                                            {{--<div class="media-left"><i class="ti-briefcase text-info"></i></div>--}}
                                            {{--<div class="media-body">--}}
                                                {{--<p>Дата регистрации: 08/17/2014</p>--}}
            ...
            <div class="widget-body">
                <form class="form-horizontal">
                    <ul role="tablist" class="nav nav-tabs mb-15">
                        <li role="presentation" class="active"><a href="#general" aria-controls="general" role="tab" data-toggle="tab">Информационные данные</a></li>
                        <li role="presentation"><a href="#shipping" aria-controls="shipping" role="tab" data-toggle="tab">Адрес доставки </a></li>
                    ...
                    <div class="tab-content">
                        <div id="general" role="tabpanel" class="tab-pane active">
                            <div class="form-group">
                                <label for="txtCustomer" class="col-sm-3 control-label">ФИО</label>
                                <div class="col-sm-9">
                                    <input id="txtCustomer" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="txtCustomerGroup" class="col-sm-3 control-label">Группа покупателей</label>
                                <div class="col-sm-9">
                                    <input id="txtCustomerGroup" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="txtFirstName" class="col-sm-3 control-label">моб. номер</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="txtEmail" class="col-sm-3 control-label">Дата регистрации</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="txtFax" class="col-sm-3 control-label">Бонусы</label>
                                <div class="col-sm-9">
                        ...
                        <div id="shipping" role="tabpanel" class="tab-pane">
                            ...
                            <div class="form-group">
                                <label for="txtZip" class="col-sm-3 control-label">Почтовый индекс</label>
                                <div class="col-sm-9">
                        ...
                        <div id="orders" role="tabpanel" class="tab-pane">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th style="width:40%">Название продукта</th>
                                ...
                                <tr>
                                    <td colspan="4" class="text-right">Скидки и предложения</td>
                                    <td class="text-right">$10.00</td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right">К оплате</td>
                                    <td class="text-right">$2587.00</td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th scope="row">1</th>
                                    <td>Слон эпохи цынь</td>
                                    <td class="text-right">$1899.00</td>
                                    <td class="text-right">1</td>
                                    <td class="text-right">$1899.00</td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td>Серьги с блилиантом</td>
                                ...
                                <tr>
                                    <td colspan="4" class="text-right">Всего</td>
                                    <td class="text-right">$5597.00</td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-right">Скидки и предложения</td>
                                    <td class="text-right">$10.00</td>
                                ...
                                <tr>
                                    <td colspan="4" class="text-right">К оплате</td>
                                    <td class="text-right">$5587.00</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    {{--<a href="/admin/makers/1"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/2"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/3"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/4"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/5"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/6"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/7"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/8"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/9"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/10"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<td class="text-center">--}}
    {{--<div role="group" aria-label="Basic example" class="btn-group btn-group-sm">--}}
    {{--<a href="/admin/makers/11"><button type="button" class="btn btn-outline btn-primary"><i class="ti-eye"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-success"><i class="ti-pencil"></i></button></a>--}}
    {{--<a><button type="button" class="btn btn-outline btn-danger"><i class="ti-trash"></i></button></a>--}}
    {{--</div>--}}
    {{--</td>--}}
    ...
    {{--<input id="single-date-picker" type="text" value="01/01/2015 - 02/15/2015" class="form-control">--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--<div class="col-md-6">--}}
    {{--<div class="form-group">--}}
