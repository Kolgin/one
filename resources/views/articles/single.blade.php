            ...
            <div class="col-lg-12">
                <div class="widget">
                    <div class="widget-heading">
                        <h3 class="widget-title"><input type="text" placeholder="Заголовок статьи" class="form-control"><div class="form-group">
                          <input type="file">
                         
                        </div></h3>
                    </div>
                    <div class="widget-body">
                  <textarea id="ckeditor-full">
...
@endsection
@section('script')
    <script type="text/javascript" src="/js/page-content/editors/ckeditor.js"></script>
@stop