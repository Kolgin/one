...
@section('content')
    <div class="page-header clearfix">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mt-0 mb-5">Редактирование профиля производителя</h4>
    ...
    <div class="row ml-10 mr-10 pt-10">
        ...
        <div class="col-md-6">
                    ...
                    <ul class="media-list mb-0">
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <input id="txtCustomerName" type="text" class="form-control" value="Пр. Героев 138\">
                            </div>
                                ...
                                <div class="col-md-13">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="date-added" type="text" class="form-control" value="20.19.1990"><span class="input-group-addon" ><span class="ti-calendar"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <p>Инн: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="3456785678">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <p>ОРГН: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="49827564383">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <p>БИК: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="987368761289">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <p>P/C: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="467548489897">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <input id="txtCustomerName" type="text" class="form-control" value="Разроботчик программного обеспечения">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                {{--<input id="txtCustomerName" type="text" class="form-control" value="">--}}
                            </div>
                        ...
                        <li class="media">
                            {{--<div class="media-left"><i class="ti-briefcase text-info"></i></div>--}}
                            <div class="media-body">
                                <p><a href="url('/admin/producrs/1')">Кол-во заказов: 6 - оплаченных, сумма - 2000000 руб, 40 - неоплаченных, сумма - 250000</a></p>
                                {{--<input id="txtCustomerName" type="text" class="form-control" value="">--}}
                            </div>
            ...
            <div class="widget clear">
                ...
                <div class="widget-body">
                    <textarea id="txtCustomerName" type="textarea" rows="6" cols="100" class="form-control" ></textarea>
                </div>
            </div>
            ...
            <div class="widget clear">
                ...
                <div class="widget-body">
                    ...
                    <div style="display: inline-block">
                        <input id="txtCustomerName" type="text" class="form-control" value="Иванова Катерина Викторовна">
                        <input id="txtCustomerName" type="text" class="form-control" value="Должность: шеф">
                        <input id="txtCustomerName" type="text" class="form-control" value="Информация:">
                    </div>
                    <form enctype="multipart/form-data" method="post">
                        <p><input type="file" name="f" value="Выберите аватарку">
                            <input type="submit" value="Загрузить аватарку "></p>
                ...
                <div class="widget-body">
                    ...
                    <div style="display: inline-block">
                        <input id="txtCustomerName" type="text" class="form-control" value="Иванов Степан Викторович">
                        <input id="txtCustomerName" type="text" class="form-control" value="Должность: шеф">
                        <input id="txtCustomerName" type="text" class="form-control" value="Информация:">
                    </div>
                    <form enctype="multipart/form-data" method="post">
                ...
                <div class="widget-body">
                    <div class="media-left" style="display: inline-block;"><a href="javascript:void(0)" style=" display: inline-block; border-radius: 50%; padding: 3px; background-color: #fff;"><img src="/images/users/03.jpg" width="100" alt=""></a></div>
                    <div style="display: inline-block">
                        <input id="txtCustomerName" type="text" class="form-control" value="Степанова Лариса Викторовна">
                        <input id="txtCustomerName" type="text" class="form-control" value="Должность: шеф">
                        <input id="txtCustomerName" type="text" class="form-control" value="Информация:">
                    </div>
                    <form enctype="multipart/form-data" method="post">
                        <p>
                            <input type="file" name="f" value="Выберите аватарку">
