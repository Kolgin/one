...
@section('content')
    <div class="page-header clearfix">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mt-0 mb-5">Редактирование профиля менеджера</h4>
        ...
        <div class="col-md-3">
            <div class="widget clear">
                <div style="width: auto" class="media-body media-middle">
                    ...
                    <a href="/admin/managers/1"><button type="button" class="btn btn-default" style="width: 150px">Сохранить</button></a>
                    ...
                    <ul class="media-list mb-0">
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <input id="txtCustomerName" type="text" class="form-control" value="Email: lethemes@gmail.com">
                            </div>
                        </li>
                        <li class="media">
                            {{--<div class="media-left"><i class="ti-gift text-info"></i></div>--}}
                                ...
                                <div class="col-md-13">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="date-added" type="text" class="form-control" value="08.17.1984"><span class="input-group-addon"><span class="ti-calendar"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="media">
                            {{--<div class="media-left"><i class="ti-briefcase text-info"></i></div>--}}
                            <div class="media-body">
                                <p>План продаж на месяц: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="250 000 руб">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <p>Выполнен на: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="700 000 руб">
                            </div>
                        ...
                        <li class="media">
                            ...
                            <div class="media-body">
                                <p>Зарплата: </p>
                                <input id="txtCustomerName" type="text" class="form-control" value="120 000 руб + 5%">
                            </div>
