...
@section('content')
    <div class="page-header clearfix">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mt-0 mb-5">Профиль менеджера</h4>
        ...
        <div class="col-md-3">
            <div class="widget clear">
                <div style="width: auto" class="media-body media-middle">
                    ...
                    <a href="/admin/managers/1/edit"><button type="button" class="btn btn-default" style="width: 150px">Редактировать</button></a>
                </div>
                ...
                <div class="widget-body">
                    <ul class="media-list mb-0">
                        ...
                        <li class="media">
                            {{--<div class="media-left"><i class="ti-gift text-info"></i></div>--}}
                            <div class="media-body">
                                <p>Доп. моб. телефон: +30678827506</p>
                            </div>
                        </li>
                        <li class="media">
                            {{--<div class="media-left"><i class="ti-email text-info"></i></div>--}}
                        ...
                        <li class="media">
                            {{--<div class="media-left"><i class="ti-briefcase text-info"></i></div>--}}
                            <div class="media-body">
                                <p>План продаж на месяц: 250 000 руб</p>
